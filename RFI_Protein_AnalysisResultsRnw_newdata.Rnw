...
sd_depleted <- laply(1:dim(dat_final)[1], function(i)out_model(deplete[i,], depleted = "TRUE"))

sd_whole <- laply(1:dim(dat_final)[1], function(i)out_model(whole[i,], depleted = "FALSE"))
@
